...
let conn = new Mysqli({
    host: 'bf7ypxy7rftug3wzf9hj-mysql.services.clever-cloud.com', // IP/domain name 
    post: 3306, // port, default 3306 
    user: 'ux5vgcctbaxckvfd', // username 
    passwd: 'zRtOJ9sG5Y0QJnwNFSiY', // password 
    db: 'bf7ypxy7rftug3wzf9hj'
});
